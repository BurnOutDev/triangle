...
{
    public class TaxUpdatedDomainEvent : DomainEvent
    {
        ...
        public TaxUpdatedDomainEvent(Guid uId, string name, TaxScope scope, TaxComputation computation, decimal value)
        {
            UId = uId;
            Name = name;
            Scope = scope;
