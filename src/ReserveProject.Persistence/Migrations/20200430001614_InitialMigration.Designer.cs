...
namespace ReserveProject.Persistence.Migrations
{
    ...
    [Migration("20200430001614_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReserveProject.Domain.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ReserveProject.Domain.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ReserveProject.Domain.ReservationCustomer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ReserveProject.Domain.RestaurantMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ReserveProject.Domain.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ReserveProject.Domain.Organization", b =>
                {
                    b.HasOne("ReserveProject.Domain.Customer", "Representative")
                        .WithMany()
            ...
            modelBuilder.Entity("ReserveProject.Domain.Restaurant", b =>
                {
                    ...
                    b.HasOne("ReserveProject.Domain.Location", "Location")
                        .WithMany()
                        .HasForeignKey("LocationId");

                    b.HasOne("ReserveProject.Domain.Organization", "Organization")
                        .WithMany()
