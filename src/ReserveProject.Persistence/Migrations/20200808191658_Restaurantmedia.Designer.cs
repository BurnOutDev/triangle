...
namespace ReserveProject.Persistence.Migrations
{
    ...
    [Migration("20200808191658_Restaurantmedia")]
    partial class Restaurantmedia
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReserveProject.Domain.Reservation", b =>
                {
                    ...
                    b.Property<int>("PartySizeAdults")
                        .HasColumnType("int");

                    b.Property<int>("PartySizeChildren")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReserveProject.Domain.ReviewMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ReserveProject.Domain.RestaurantMedia", b =>
                {
                    b.HasOne("ReserveProject.Domain.Media", "Media")
                        .WithMany()
                        .HasForeignKey("MediaId");

                    b.HasOne("ReserveProject.Domain.Restaurant", "Restaurant")
                        .WithMany("RestaurantMedia")
                        .HasForeignKey("RestaurantId");
                });
            ...
            modelBuilder.Entity("ReserveProject.Domain.ReviewMedia", b =>
                {
                    ...
                    b.HasOne("ReserveProject.Domain.Review", "Review")
