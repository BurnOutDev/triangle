...
{
    public class MenuItemsIngredientConfiguration : EntityConfiguration<MenuItemsIngredient>
    {
        public override void Map(EntityTypeBuilder<MenuItemsIngredient> builder)
        {
